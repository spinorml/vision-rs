...
- `parking-garage-client` serves a small Vue page and exposes an HTTP/WebSocket API for the browser.
...
Run the browser-facing client in another terminal:

```bash
cargo run --bin parking-garage-client
```
