// CIoU loss forward test.
//
// Verifies the yolo_ciou_loss_forward kernel against PyTorch-generated
// reference outputs (fixtures/yolo_ciou_loss/).
//
// Pred / target layout: [4, N] channels-first (cx, cy, w, h).
// Output: [N] per-anchor CIoU loss.
